...
<ul>
  ...
  <li><strong>Anonymous analytics:</strong> I use the self-hosted tool <a href="https://github.com/usefathom/fathom" class="text-grey-darkest font-normal underline">Fathom</a> to collect anonymous page visits and referrers. I only log these non-personal information after you agree on the cookie banner.</li>
</ul>
